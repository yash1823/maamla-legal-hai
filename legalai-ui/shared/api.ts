...
export interface DbDebugResponse {
  stats: DbDebugStats;
  recent_entries: CaseMetaEntry[];
}

export interface UserDebugStats {
  total_users: number;
  users_without_bookmarks: number;
...
export interface TopUserByBookmarks {
  id: string;
  email: string;
  name: string;
...
export interface UsersDebugResponse {
  stats: UserDebugStats;
  recent_users: RecentUser[];
  top_users_by_bookmarks: TopUserByBookmarks[];
}
